...
public class OrdersTabFrame extends JFrame {
    private final AppFrame parent;

    public OrdersTabFrame(AppFrame parent) {
        this(parent, null, "TRA CỨU HÓA ĐƠN");
    }

    public OrdersTabFrame(AppFrame parent, OrderDAO.OrderFilter presetFilter, String headerTitle) {
        this.parent = parent;
        ...
        OrdersManagementPanel panel = new OrdersManagementPanel(() -> {
            try {
        ...
        addWindowListener(new java.awt.event.WindowAdapter() {
            ...
            public void windowClosed(java.awt.event.WindowEvent e) {
                if (OrdersTabFrame.this.parent != null) {
                    OrdersTabFrame.this.parent.setVisible(true);
                }
            }
        });
