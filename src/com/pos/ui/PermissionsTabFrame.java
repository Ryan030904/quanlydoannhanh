...
public class PermissionsTabFrame extends JFrame {
    private final AppFrame parent;

    public PermissionsTabFrame(AppFrame parent) {
        this.parent = parent;
        ...
        PermissionsManagementPanel panel = new PermissionsManagementPanel(() -> {
            try {
        ...
        addWindowListener(new java.awt.event.WindowAdapter() {
            ...
            public void windowClosed(java.awt.event.WindowEvent e) {
                if (PermissionsTabFrame.this.parent != null) {
                    PermissionsTabFrame.this.parent.setVisible(true);
                }
            }
        });
