...
public class SuppliersTabFrame extends JFrame {
    private final AppFrame parent;

    public SuppliersTabFrame(AppFrame parent) {
        this.parent = parent;
        ...
        SuppliersManagementPanel panel = new SuppliersManagementPanel(null);
        ...
        addWindowListener(new java.awt.event.WindowAdapter() {
            ...
            public void windowClosed(java.awt.event.WindowEvent e) {
                if (SuppliersTabFrame.this.parent != null) {
                    SuppliersTabFrame.this.parent.setVisible(true);
                }
            }
        });
