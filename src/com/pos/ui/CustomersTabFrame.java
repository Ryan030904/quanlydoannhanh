...
public class CustomersTabFrame extends JFrame {
    private final AppFrame parent;

    public CustomersTabFrame(AppFrame parent) {
        this.parent = parent;
        ...
        CustomersManagementPanel panel = new CustomersManagementPanel(parent, null);
        ...
        addWindowListener(new java.awt.event.WindowAdapter() {
            ...
            public void windowClosed(java.awt.event.WindowEvent e) {
                if (CustomersTabFrame.this.parent != null) {
                    CustomersTabFrame.this.parent.setVisible(true);
                }
            }
        });
