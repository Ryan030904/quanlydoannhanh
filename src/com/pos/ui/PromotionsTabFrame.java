...
public class PromotionsTabFrame extends JFrame {
    private final AppFrame parent;

    public PromotionsTabFrame(AppFrame parent) {
        this.parent = parent;
        ...
        PromotionsManagementPanel panel = new PromotionsManagementPanel(() -> {
            try {
        ...
        addWindowListener(new java.awt.event.WindowAdapter() {
            ...
            public void windowClosed(java.awt.event.WindowEvent e) {
                if (PromotionsTabFrame.this.parent != null) {
                    PromotionsTabFrame.this.parent.setVisible(true);
                }
            }
        });
