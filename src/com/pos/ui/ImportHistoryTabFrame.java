...
public class ImportHistoryTabFrame extends JFrame {
    private final AppFrame parent;

    public ImportHistoryTabFrame(AppFrame parent) {
        this.parent = parent;
        ...
        ImportHistoryManagementPanel panel = new ImportHistoryManagementPanel(() -> {
            try {
        ...
        addWindowListener(new java.awt.event.WindowAdapter() {
            ...
            public void windowClosed(java.awt.event.WindowEvent e) {
                if (ImportHistoryTabFrame.this.parent != null) {
                    ImportHistoryTabFrame.this.parent.setVisible(true);
                }
            }
        });
