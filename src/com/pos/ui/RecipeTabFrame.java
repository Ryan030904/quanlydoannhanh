...
public class RecipeTabFrame extends JFrame {
    private final AppFrame parent;

    public RecipeTabFrame(AppFrame parent) {
        this.parent = parent;
        ...
        RecipeManagementPanel panel = new RecipeManagementPanel(() -> {
            try {
        ...
        addWindowListener(new java.awt.event.WindowAdapter() {
            ...
            public void windowClosed(java.awt.event.WindowEvent e) {
                if (RecipeTabFrame.this.parent != null) {
                    RecipeTabFrame.this.parent.setVisible(true);
                }
            }
        });
