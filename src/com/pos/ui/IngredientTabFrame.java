...
public class IngredientTabFrame extends JFrame {
    private final AppFrame parent;

    public IngredientTabFrame(AppFrame parent) {
        this.parent = parent;
        ...
        IngredientManagementPanel panel = new IngredientManagementPanel(() -> {
            try {
        ...
        addWindowListener(new java.awt.event.WindowAdapter() {
            ...
            public void windowClosed(java.awt.event.WindowEvent e) {
                if (IngredientTabFrame.this.parent != null) {
                    IngredientTabFrame.this.parent.setVisible(true);
                }
            }
        });
